...
data$trait <- factor(data$trait, levels=c("mindex","pct_iso","pct_anteiso","nalk_ACL","iso_ACL","anteiso_ACL","nalk_CPI","iso_CPI","anteiso_CPI","D_iC31","D_nC31","D_iC33","D_nC33","n31.i31","n33.i33"))
