...
#data <- read.table("./4.master_qtl_plot.txt", header=TRUE)
data <- read.delim("~/GoogleDrive/Grad_school/Research/Tomatoes/Paper_drafts/d13C_CSIA/Figures/3.QTL analysis/QTL modeling/5.master_qtl_plot.txt")

data$trait <- factor(data$trait, levels=c("nalk_ACL","nalk_CPI","iso_ACL","iso_CPI","anteiso_ACL","anteiso_CPI","eps13C_n.C31","eps13C_i.C31","eps13C_n.C33","eps13C_i.C33","n31.i31","n33.i33","mindex","pct_iso","pct_anteiso","Sum_Alk.area"))
