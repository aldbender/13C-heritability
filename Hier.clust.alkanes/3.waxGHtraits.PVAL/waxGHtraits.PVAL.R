...
# Plot without extras
t + geom_tile() +scale_fill_gradient2(low="darkorange4", mid="orange", high="purple4")  +theme_bw() + coord_fixed() +theme(axis.title.x=element_blank(), axis.text.x=element_blank(), axis.ticks.x=element_blank(), axis.title.y=element_blank(), axis.text.y=element_blank(), axis.ticks.y=element_blank()) +guides(fill=FALSE)
